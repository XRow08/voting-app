    ...
    return (
      <div className="flex justify-between w-full max-w-md mt-6">
        ...
        <div className="flex items-center border border-gray-500 rounded-full px-4 py-2">
          ...
          <span className="text-white ml-1 text-[12px]">5,430 Attendees</span>
        </div>
      </div>
    );
  }
